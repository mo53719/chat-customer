import { AppstoreOutlined, MessageOutlined, DashboardOutlined, FileTextOutlined,
...
export const pageMetas: PageMeta[] = [
  ...
  { group: "business", path: "/ops", title: "运维观测", icon: <ControlOutlined />, order: 50, requireAuth: true },
  { group: "business", path: "/recycle", title: "回收站", icon: <DeleteOutlined />, order: 60, requireAuth: true },

  // 团队设置
  { group: "team", path: "/team/llm", title: "大模型设置", icon: <ApiOutlined />, order: 10, requireAuth: true },
  { group: "team", path: "/team/rag", title: "RAG 知识库", icon: <FileTextOutlined />, order: 20, requireAuth: true },
  { group: "team", path: "/team/config", title: "配置列表", icon: <OrderedListOutlined />, order: 30, requireAuth: true },
  { group: "team", path: "/team/channels", title: "渠道管理", icon: <GlobalOutlined />, order: 40, requireAuth: true },
  { group: "team", path: "/team/agents", title: "客服管理", icon: <CustomerServiceOutlined />, order: 50, requireAuth: true },
  ...
  // 商城设置
  { group: "mall", path: "/mall/merchant", title: "商家设置", icon: <ShopOutlined />, order: 10, requireAuth: true },
  ...
  // 系统设置
  { group: "system", path: "/system/general", title: "通用设置", icon: <GlobalOutlined />, order: 10, requireAuth: true },
  { group: "system", path: "/system/badcase", title: "失败案例", icon: <BugOutlined />, order: 20, requireAuth: true },
];
