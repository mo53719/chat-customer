...
_REGION_RULES = [
    (re.compile(r"^(10\.|192\.168\.|172\.(1[6-9]|2\d|3[01])\.|127\.)"), "内网"),
    (re.compile(r"^(36\.|39\.|42\.|49\.|58\.|59\.|60\.|61\.|101\.|103\.|110\.|111\.|112\.|113\.|114\.|115\.|116\.|117\.|118\.|119\.|120\.|121\.|122\.|123\.|124\.|125\.|126\.|175\.|180\.|182\.|183\.|202\.|203\.|210\.|211\.|218\.|219\.|220\.|221\.|222\.|223\.)"), "中国"),
    (re.compile(r"^(8\.|12\.|24\.|32\.|40\.|56\.|64\.|72\.|96\.|104\.|172\.|192\.|198\.|199\.|204\.|205\.|206\.|207\.|208\.)"), "海外"),
]
...
class ChatService:
    ...
    async def chat_stream(session_id: str, message: str, user_id: int | None = None,
        ...
        """流式对话（简化版：先跑完同步拿答案，再分段 yield）。

        生产环境可改造为 graph 内部流式，这里先保证可用。
        """
        result = await ChatService.chat(session_id, message, user_id, channel, visitor_ip)
